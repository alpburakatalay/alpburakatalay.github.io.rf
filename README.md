...
<select id="env">
<option value="1">Açık Alan</option>
<option value="0.5">Şehir İçi</option>
<option value="0.3">Yoğun Beton</option>
</select>

<br>
<label>
<input type="checkbox" id="grafikSec"> Grafik Göster
</label>
<br>
...
<p class="small">
Tüm hesaplamalar teoriktir. Gerçek sonuç ortam ve ekipmana göre değişir.
</p>
...
function hesapla(){
    ...
    document.getElementById("sonuc").innerHTML =
        ...
        "Tahmini Gerçek: " + gercek.toFixed(2) + " km";
...
function grafikOlustur(h2, factor){
    ...
    chart = new Chart(ctx, {
        ...
        options: {
            ...
            scales:{
                x:{
                    title:{display:true,text:"1. Anten Yüksekliği (m)",color:"#e2e8f0"},
                    ticks:{color:"#e2e8f0"}
                },
                y:{
